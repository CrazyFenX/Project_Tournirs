...
namespace DataViewer_D_v._001
{
    public class Duet
    {
        ...
        public List<List<bool>> judgeMarkListScating = new List<List<bool>>();
        public List<List<int>> judgeMarkScatingFinalList = new List<List<int>>();

        public int skatingPosition = -1;

        public List<Trainer> trainers = new List<Trainer>();

        public Trainer oldTrainer = new Trainer();
        ...
        public Duet(int Num, int GroupNum, int NumInGroup, Sportsman Sportsman1, Sportsman Sportsman2, double mark):this(Num, GroupNum, Sportsman1, Sportsman2)
        {
            this.mark = mark;
        ...
        public Duet(int Num, int GroupNum, int NumInGroup, Sportsman Sportsman1, double Mark): this(Num, GroupNum, Sportsman1)
        {
            this.mark = Mark;
            this.numberInGroup = NumInGroup;
        }
        ...
        public string ToStringScating()
        {
            string retstr = "";
            retstr += "Пара " + number.ToString() + " В Группе " + groupNumber.ToString() + " Под помером " + numberInGroup.ToString() + " \n" + sportsman1.ToString() + " " + sportsman2.ToString();
            if (this.markSum >= 0)
                retstr += " Баллы: " + this.markSum.ToString() + "\n";
            return retstr;
        }
