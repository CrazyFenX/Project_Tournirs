...
namespace DataViewer_D_v._001
{
    public class Controller
    {
        ...
        public static void insertTrainer(Trainer trainer, int bookNumber)
        {
            ...
            commandTrain.CommandText = "INSERT INTO Trainers(НомерКнижки, Код, Фамилия, Имя, Отчество)" + "VALUES (@bookNumber, @Surname, @Name, @Patronymic)";
        ...
        public static string AgeCategoryAutoFill(ComboBox DayOfBirth_comboBox, ComboBox MounthOfBirth_comboBox, ComboBox YearOfBirth_comboBox, List<string> AgeList, int exceptionFlag = 0)
        {
            try
            {
                if (DayOfBirth_comboBox.SelectedIndex != -1 && MounthOfBirth_comboBox.SelectedIndex != -1 && YearOfBirth_comboBox.SelectedIndex != -1)
                {
                   ...
                   // MessageBox.Show(differ.ToShortDateString());
                    ...
                    switch (age) //{ "Д-0", "Д-1", "Д-2", "Ю-1", "Ю-2", "М-1", "М-2", "Вз", "Другой" }
                    {
                        case 0:
                        case 1:
                        case 2:
        ...
        public static void takeSportClassSet(int index, ref ComboBox second)
        {
            second.Items.Clear();
            switch (index) //{ "Д-0", "Д-1", "Д-2", "Ю-1", "Ю-2", "М-1", "М-2", "Вз", "Другой" }
            {
                case 0:
                    second.Items.AddRange(new object[] { "H", "-" }); // Д-0
                    break;
                case 1:
                    second.Items.AddRange(new object[] {"H", "E", "D", "-" }); //Д-1
                    break;
                case 2:
                    second.Items.AddRange(new object[] { "H", "E", "D", "C", "-" });//Д-2
                    break;
                case 3:
                    second.Items.AddRange(new object[] { "H", "E", "D", "C", "B", "-" });//Ю-1
                    break;
                case 4:
                    second.Items.AddRange(new object[] { "H", "E", "D", "C", "B", "A", "-" });//Ю-2
                    break;
                case 5:
                    second.Items.AddRange(new object[] { "H", "E", "D", "C", "B", "A", "S", "-" });//M-1
                    break;
                case 6:
                    second.Items.AddRange(new object[] { "H", "E", "D", "C", "B", "A", "S", "M", "-" });//M-2
                    break;
                case 7:
                    second.Items.AddRange(new object[] { "H", "E", "D", "C", "B", "A", "S", "M", "-" });//Вз
                    break;
                default:
                    second.Items.AddRange(new object[] { "H", "E", "D", "C", "B", "A", "S", "M", "-" });//Вз
                    //second.Items.Clear();
