    ...
    public partial class CreatingTournirDBForm : Form
    {
        ...
        private void Create_button_Click(object sender, EventArgs e)
        {
                ...
                HourTournirStart_comboBox.SelectedIndex != -1 && MinutesTournirStart_comboBox.SelectedIndex != -1 && CityOfTournir_textBox.Text != "" && OrganisationOfTournir_textBox.Text != "")
            {
                ...
                this.previousForm.secretaryMainForm.Path_textBox.Text = folderName + '\\' + Name_textBox.Text + '\\' + Name_textBox.Text + ".mdb";
                this.previousForm.secretaryMainForm.folderName =  folderName + '\\' + Name_textBox.Text + '\\' + Name_textBox.Text + ".mdb";
            }
            else
            {
